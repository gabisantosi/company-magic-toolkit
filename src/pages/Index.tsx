...
import { ArrowRight, Sparkles, Building2, CheckCircle } from "lucide-react";

const Index = () => {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-accent via-white to-transparent">
      <Navbar />
              ...
              <div className="relative space-y-8">
                ...
                <div className="space-y-4 text-center">
                  ...
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-fade-in delay-100">
                    Get AI-powered recommendations for your business structure and SNI codes
                  </p>
                </div>
                ...
                {/* Features */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 animate-fade-in delay-300">
                  <div className="backdrop-blur-sm bg-white/40 p-6 rounded-xl border border-white/20 hover:border-swedish-blue/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <p className="text-gray-600">
                      Get personalized recommendations for choosing between Aktiebolag (AB) or Enskild Firma
                    </p>
                  </div>
                  <div className="backdrop-blur-sm bg-white/40 p-6 rounded-xl border border-white/20 hover:border-swedish-blue/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <CheckCircle className="h-8 w-8 text-swedish-blue mb-4" />
                    <h3 className="text-lg font-semibold text-swedish-blue mb-2">
                      SNI Code Suggestions
                    </h3>
                    <p className="text-gray-600">
                      Receive AI-recommended SNI codes based on your business description
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-16 pt-8 border-t border-swedish-blue/10 text-center animate-fade-in delay-400">
                  <p className="text-sm text-gray-500">
                    Powered by advanced AI to help entrepreneurs make informed decisions
                  </p>
                </div>
              </div>
            </div>
